...
import jdbc.JdbcExampleCreateIndexes;
import jdbc.JdbcExampleCreateTables;
...
public class JavaSample {
    ...
    public static void main(String[] args) throws Exception {
    	//Ignition.setClientMode(true);¿¨ËÀ£¿
        ...
        try (Ignite ignite = Ignition.start()) {
            ...
            JdbcExampleCreateTables.main(args);
            JdbcExampleCreateIndexes.main(args);
